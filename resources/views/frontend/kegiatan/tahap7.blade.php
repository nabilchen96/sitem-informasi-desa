    ...
    <div style="width: 100%;">
        ...
        <form id="form">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="mb-4">
                        <label class="form-label">File Seminar Antara <sup class="text-danger">*</sup></label>
                        <input type="file" name="file_seminar_antara" id="file_seminar_antara"
