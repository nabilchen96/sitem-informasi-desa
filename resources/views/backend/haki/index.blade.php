        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-12 col-xl-8 mb-xl-0">
                    <h3 class="font-weight-bold">Data HAKI</h3>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                <form id="form">
                    <div class="modal-header p-3">
                        <h5 class="modal-title m-2" id="exampleModalLabel">HAKI Form</h5>
                    </div>
...
@push('script')
    <script>
        ...
        function getData() {
            $("#myTable").DataTable({
                ...
                columns: [{
                    ...
                    {
                        render: function(data, type, row, meta) {
                            return `<a href="/file_haki/${row.file}">
        ...
        form.onsubmit = (e) => {
            ...
            axios({
                    method: 'post',
                    url: formData.get('id') == '' ? '/store-haki' : '/update-haki',
                    data: formData,
                })
                .then(function(res) {
                    //handle success         
