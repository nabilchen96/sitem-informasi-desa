    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-12 col-xl-8 mb-xl-0">
                <h3 class="font-weight-bold">Data Informasi</h3>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            <form id="form">
                <div class="modal-header p-3">
                    <h5 class="modal-title m-2" id="exampleModalLabel">Informasi Form</h5>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Informasi <sup class="text-danger">*</sup></label>
                        <textarea name="informasi" id="informasi" rows="5" cols="5" class="form-control"></textarea>
                    </div>
                    <div class="form-group">
    ...
    <script>
        ...
        function getData() {
            $("#myTable").DataTable({
                ...
                @if (Auth::user()->role == 'Admin')
                    columnDefs: [
                        { orderable: false, targets: [4, 5] } // Kolom ke-0 dan ke-2 tidak bisa di-sort
                    ],
                @endif
